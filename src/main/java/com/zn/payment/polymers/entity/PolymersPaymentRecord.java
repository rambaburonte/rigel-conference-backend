package com.zn.payment.polymers.entity;
...
@Entity
@Table(name = "polymers_payment_records")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class PolymersPaymentRecord {
    ...
    private PolymersPricingConfig pricingConfig;
    ...
    @JsonBackReference
    private PolymersRegistrationForm registrationForm;
    ...
    public static PolymersPaymentRecord fromStripeResponse(String sessionId, String customerEmail, 
                                                 BigDecimal amountTotalEuros, String currency,
                                                 LocalDateTime stripeCreatedAt, 
                                                 LocalDateTime stripeExpiresAt,
                                                 String paymentStatus) {
        return PolymersPaymentRecord.builder()
                .sessionId(sessionId)
    ...
    public static PolymersPaymentRecord fromPayPalResponse(String orderId, String customerEmail,
                                                         BigDecimal amountTotalEuros, String currency) {
        return PolymersPaymentRecord.builder()
                .sessionId(orderId)
                .customerEmail(customerEmail)
    ...
    public static PolymersPaymentRecord fromPricingConfig(String sessionId, String customerEmail, 
    ...
    public static PolymersPaymentRecord fromStripeWithPricing(String sessionId, String customerEmail,
                                                     String currency, PolymersPricingConfig pricingConfig,
                                                     LocalDateTime stripeCreatedAt,
                                                     LocalDateTime stripeExpiresAt,
                                                     String paymentStatus) {
        PolymersPaymentRecord record = fromPricingConfig(sessionId, customerEmail, currency, pricingConfig,
