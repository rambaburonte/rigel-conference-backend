...
@NoArgsConstructor
@AllArgsConstructor
public class RenewablePaymentResponseDTO {
     ...
     */
    public static RenewablePaymentResponseDTO fromEntity(RenewablePaymentRecord record) {
    	RenewablePaymentResponseDTOBuilder builder = RenewablePaymentResponseDTO.builder()
            .id(record.getId())
