...
@NoArgsConstructor
@AllArgsConstructor
public class NursingPaymentResponseDTO {
     ...
     */
    public static NursingPaymentResponseDTO fromEntity(NursingPaymentRecord record) {
    	NursingPaymentResponseDTOBuilder builder = NursingPaymentResponseDTO.builder()
            .id(record.getId())
